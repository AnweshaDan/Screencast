...
function index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    ...
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(_env_json__WEBPACK_IMPORTED_MODULE_7__.api + "/api/status").then(function (response) {
      ...
      setloading(true); //if(localStorage.getItem('end') < Date.now()) Router.push('/finale2');
    });
  });
...
//# sourceMappingURL=index.js.9d762f706ec22da7e958.hot-update.js.map