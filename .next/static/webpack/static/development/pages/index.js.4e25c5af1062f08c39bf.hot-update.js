      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post(_env_json__WEBPACK_IMPORTED_MODULE_16__.api + "/api/googlelogin", {
        ...
        _this.setState({
          ...
          if (localStorage.getItem('start') <= Date.now()) {
            ...
            } else next_router__WEBPACK_IMPORTED_MODULE_14___default.a.push("/game");
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(GoogleLog, [{
    ...
    value: function componentDidMount() {
      ...
      if (localStorage.getItem("email")) {
        ...
        if (this.state.quiz_finished) next_router__WEBPACK_IMPORTED_MODULE_14___default.a.push('/finale'); //if((localStorage.getItem('start') < Date.now())) Router.push("/game");
      }
...
//# sourceMappingURL=index.js.4e25c5af1062f08c39bf.hot-update.js.map