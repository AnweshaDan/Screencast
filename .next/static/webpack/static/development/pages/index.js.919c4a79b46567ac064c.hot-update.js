  ...
  function GoogleLog3() {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "refresh", function (res) {
      ...
      var t = setInterval(function () {
        alert("Refreshing");
        axios__WEBPACK_IMPORTED_MODULE_9___default.a.post("http://screencast20.azurewebsites.net/api/refresh", {
    ...
    Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_2__["default"])(_this), "responseGoogle", function (response) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_9___default.a.post("http://screencast20.azurewebsites.net/api/googlelogin", {
        token: response.tokenObj.access_token
      }).then(function (res) {
        console.log(res); // localStorage.setItem('token',res.data.access_token)
      ...
      localStorage.setItem("image", response.profileObj.imageUrl); //console.log(localStorage.getItem("token"));
...
//# sourceMappingURL=index.js.919c4a79b46567ac064c.hot-update.js.map