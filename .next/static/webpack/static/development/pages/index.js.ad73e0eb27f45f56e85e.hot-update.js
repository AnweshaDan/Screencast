      ...
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function componentDidMount$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              console.log("mounted");
              res = axios__WEBPACK_IMPORTED_MODULE_10___default.a.post(_env_json__WEBPACK_IMPORTED_MODULE_17__.api + "/api/googlelogin", {
              ...
              /*if(localStorage.getItem("email"))
              {
                ...
                if(this.state.quiz_finished) Router.push('/finale')
...
//# sourceMappingURL=index.js.ad73e0eb27f45f56e85e.hot-update.js.map