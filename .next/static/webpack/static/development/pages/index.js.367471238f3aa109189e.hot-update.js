...
function index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(_env_json__WEBPACK_IMPORTED_MODULE_9__.api + "/api/status").then(function (response) {
      ...
      var now2 = new Date(response.data.start_time);
      setStart(now2.getTime() + now2.getTimezoneOffset() * 60000); //setStart((new Date("2020-07-20T13:16:27Z")).getTime());

      var now = new Date(response.data.end_time);
      setEnd(now.getTime() + now.getTimezoneOffset() * 60000);
...
//# sourceMappingURL=index.js.367471238f3aa109189e.hot-update.js.map