      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.get('https://jsonplaceholder.typicode.com/posts/' + this.state.qsNo).then(function (response) {
        ...
        if (_this3.state.qsNo < 5) {
          if (answer == r) {
            ...
            react_dom__WEBPACK_IMPORTED_MODULE_19___default.a.render(__jsx("div", {
              __self: _this3,
              __source: {
                fileName: _jsxFileName,
                lineNumber: 120,
...
//# sourceMappingURL=game.js.d61df95e3a1e1ed29419.hot-update.js.map