...
function index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.get(_env_json__WEBPACK_IMPORTED_MODULE_10__.api + "/api/status").then(function (response) {
      ...
      next_router__WEBPACK_IMPORTED_MODULE_9___default.a.push('/game'); //if(localStorage.getItem('end') < Date.now()) Router.push('/finale2');
    });
  });
  return __jsx("div", {
    style: {
...
//# sourceMappingURL=index.js.148217d27d6d16527605.hot-update.js.map