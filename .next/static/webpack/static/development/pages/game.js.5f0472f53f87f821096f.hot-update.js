      ...
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.get('https://jsonplaceholder.typicode.com/posts/' + this.state.qsNo).then(function (response) {
        ...
        if (_this3.state.qsNo < 5) {
          if (answer == r) {
            ...
            _components_AnsAlert__WEBPACK_IMPORTED_MODULE_18___default()(1);
          } else {
            _this3.setState(function (prevState) {
              return _objectSpread({}, prevState, {
                correct: 0
            ...
            _components_AnsAlert__WEBPACK_IMPORTED_MODULE_18___default()(0);
          }
        } else {
...
//# sourceMappingURL=game.js.5f0472f53f87f821096f.hot-update.js.map