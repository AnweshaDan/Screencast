...
function index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    axios__WEBPACK_IMPORTED_MODULE_4___default.a.get("https://screencast2020.herokuapp.com/api/status").then(function (response) {
      ...
      if (localStorage.getItem('email') && new Date(response.data.start_time).getTime() <= Date.now()) Router.push('/game');
    });
  });
  return __jsx("div", {
...
//# sourceMappingURL=index.js.6f1100ef57cd26594bc1.hot-update.js.map