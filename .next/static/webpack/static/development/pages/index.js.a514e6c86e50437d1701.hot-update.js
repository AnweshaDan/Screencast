...
function index() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    axios__WEBPACK_IMPORTED_MODULE_3___default.a.get(_env_json__WEBPACK_IMPORTED_MODULE_10__.api + "/api/status").then(function (response) {
      ...
      if (localStorage.getItem('email') && localStorage.getItem('start') <= Date.now()) {} //if(localStorage.getItem('end') < Date.now()) Router.push('/finale2');
...
//# sourceMappingURL=index.js.a514e6c86e50437d1701.hot-update.js.map