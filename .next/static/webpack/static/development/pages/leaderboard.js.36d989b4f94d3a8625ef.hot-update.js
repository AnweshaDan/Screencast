...
function CustomizedTables() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    axios__WEBPACK_IMPORTED_MODULE_10___default.a.get('https://jsonplaceholder.typicode.com/users').then(function (response) {
      setRankList({
        RankList: Object.entries(response.data)
      });
    });
    console.log(typeof RankList.RankList[0]);
  ...
  }, Object.entries(RankList).map(function (row, index) {
...
//# sourceMappingURL=leaderboard.js.36d989b4f94d3a8625ef.hot-update.js.map